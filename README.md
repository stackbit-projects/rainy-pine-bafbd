...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/606bafbdcb6521001653b734
...
To start editing your site, you can use the Sanity interface at https://rainy-pine-bafbd.sanity.studio/.
...
Generated at `2021-04-06T01:29:06.417Z` by Stackbit version `0.3.50`.